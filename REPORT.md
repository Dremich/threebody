...
|:---:|:---:|
| ![Butterfly Orbit Animation](path/to/butterfly_orbit.gif) | ![Butterfly Phase Plot](path/to/butterfly_phase.png) |
...
<div align="center">
  <img src="path/to/figure8.gif" width="600" />
...
![Convergence Plot](path/to/convergence_plot.png)
